...
print("xxxxxxxxxxxx bps.size() ", bps.size(), "bps.local_size(): ", bps.local_size())
...
# strategy = tf.distribute.MirroredStrategy(tf.distribute.experimental.CollectiveCommunication.NCCL, devices=["/gpu:0"])
# strategy = tf.distribute.MirroredStrategy(devices=["/gpu:0"])
# strategy = bps.distribute.MyMirroredStrategy(devices=["/gpu:" + str(args.rank)])
# print("xxxxxxxxxxxxxxxxxxxxxx using device: ", "/gpu:" + str(args.rank))
strategy = bps.distribute.MyMirroredStrategy(devices=["/gpu:0"])
print("xxxxxxxxxxxxxxxxxxxxxx using device: ", "/gpu:0")
