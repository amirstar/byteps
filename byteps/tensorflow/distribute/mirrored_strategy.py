...
@tf_export("distribute.MyMirroredStrategy", v1=[])  # pylint: disable=g-classes-have-attributes
class MyMirroredStrategy(distribute_lib.Strategy):
  ...
  def __init__(self, devices=None, cross_device_ops=None):
    ...
    super(MyMirroredStrategy, self).__init__(extended)
...
class MyMirroredStrategyV1(distribute_lib.StrategyV1):  # pylint: disable=g-missing-docstring
  ...
  __doc__ = MyMirroredStrategy.__doc__
